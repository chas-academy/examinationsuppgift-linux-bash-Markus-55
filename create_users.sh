...
addUser() {  
    ...
    # Create welcome files after all users have been created,
    # so each file includes all other users
    for user in "$@"; do
	...
	# Set user as the owner of the created welcome file
	chown "$user:" "/home/$user/welcome.txt"
    done
}
